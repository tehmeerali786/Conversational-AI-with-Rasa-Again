...
class TicketFormAction(FormAction):
    ...
    def run(
        ...
        dispatch.utter_message("Entities: " + tracker.latest_message['entities'] + "\n" + "Slots: " + tracker.slots)
        return []
    ...
    def run(self, dispatch, tracker, domain):
        ...
        for entity in tracker.latest_message['entities']:
            if entity.get("group") == "1":
                entities.append(
                    {"entity": entity["entity"], "value": entity["value"], "group": entity["group"]})
                msg = msg + "group #1: " + str(entities) + "\n"

            elif entity.get("group") == "2":
                entities.append(
                    {"entity": entity["entity"], "value": entity["value"], "group": entity["group"]})
                msg = msg + "group #2: " + str(entities) + "\n"

            elif entity.get("group") == "3":
                entities.append(
                    {"entity": entity["entity"], "value": entity["value"], "group": entity["group"]})
                msg = msg + "group #3: " + str(entities) + "\n"

            elif entity.get("group") == "4":
                entities.append(
                    {"entity": entity["entity"], "value": entity["value"], "group": entity["group"]})
                msg = msg + "group #4: " + str(entities) + "\n"

            elif entity.get("group") == "5":
                entities.append(
                    {"entity": entity["entity"], "value": entity["value"], "group": entity["group"]})
                msg = msg + "group #5: " + str(entities) + "\n"

            elif entity.get("group") == "6":
                entities.append(
                    {"entity": entity["entity"], "value": entity["value"], "group": entity["group"]})
                msg = msg + "group #6: " + str(entities) + "\n"

            else:
                entities = ["Not Found"]
                msg = msg + str(entities) + "\n"
